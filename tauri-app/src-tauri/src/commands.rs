...
pub struct ComparativeEstimateDto {
    ...
    pub net_unemployment:             Option<f32>,
    pub net_legitimacy:               Option<f32>,
    pub net_treasury:                 Option<f64>,
    pub net_income:                   Option<f64>,
    pub net_wealth:                   Option<f64>,
    pub net_health:                   Option<f32>,
    /// Per-quintile net approval (A − B). Index 0 = bottom quintile.
    pub net_approval_by_quintile:     [Option<f32>; 5],
}
...
pub async fn compare_two_laws(
    ...
    Ok(ComparativeEstimateDto {
        ...
        net_unemployment:         cmp.net_unemployment(),
        net_legitimacy:           cmp.net_legitimacy(),
        net_treasury:             cmp.net_treasury(),
        net_income:               cmp.net_income(),
        net_wealth:               cmp.net_wealth(),
        net_health:               cmp.net_health(),
        net_approval_by_quintile: cmp.net_approval_by_quintile(),
...
impl From<ComparativeSummary> for ComparativeSummaryDto {
    fn from(s: ComparativeSummary) -> Self {
        Self {
            ...
            mean_net_unemployment: s.mean_net_unemployment,
            std_net_unemployment:  s.std_net_unemployment,
            p5_net_unemployment:   s.p5_net_unemployment,
            p95_net_unemployment:  s.p95_net_unemployment,
            mean_net_legitimacy:   s.mean_net_legitimacy,
            std_net_legitimacy:    s.std_net_legitimacy,
            p5_net_legitimacy:     s.p5_net_legitimacy,
            p95_net_legitimacy:    s.p95_net_legitimacy,
            mean_net_treasury:     s.mean_net_treasury,
            std_net_treasury:      s.std_net_treasury,
            p5_net_treasury:       s.p5_net_treasury,
            p95_net_treasury:      s.p95_net_treasury,
            mean_net_income:       s.mean_net_income,
            std_net_income:        s.std_net_income,
            p5_net_income:         s.p5_net_income,
            p95_net_income:        s.p95_net_income,
            mean_net_wealth:       s.mean_net_wealth,
            std_net_wealth:        s.std_net_wealth,
            p5_net_wealth:         s.p5_net_wealth,
            p95_net_wealth:        s.p95_net_wealth,
            mean_net_health:       s.mean_net_health,
